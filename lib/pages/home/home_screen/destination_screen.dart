                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return CountryListTile(
                            label: getCountrys()[index].label,
                            countryName: getCountrys()[index].countryName,
                            noOfTours: getCountrys()[index].noOfTours,
                            rating: getCountrys()[index].rating,
                            imgUrl: getCountrys()[index].imgUrl,
                          );
                        }),
                  ),
              ...
              const SizedBox(height:10),
               Container(
                 child:   ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return PopularTours(
                          desc: getPopularTours()[index].desc,
                          imgUrl: getPopularTours()[index].imgUrl,
                          title: getPopularTours()[index].title,
                          price: getPopularTours()[index].price,
                          rating: getPopularTours()[index].rating,
                        );
                      }),
